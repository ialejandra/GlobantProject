    ...
    public class ProvidersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Providers != null ? 
                          ...
                          Problem("No se encuentra los proveedores");
        }
        ...
        public async Task<IActionResult> Create([Bind("ProviderId,Nit,Title,Address,Phone,Email")] Provider provider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProviderId,Nit,Title,Address,Phone,Email")] Provider provider)
        {
