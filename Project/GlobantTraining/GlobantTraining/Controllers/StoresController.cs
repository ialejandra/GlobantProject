    ...
    public class StoresController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Store != null ? 
                          ...
                          Problem("No se encuentra la tienda");
        }
        ...
        public async Task<IActionResult> Create([Bind("StoreId,Title,Email,Phone,Address")] Store store)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StoreId,Title,Email,Phone,Address")] Store store)
        {
            if (id != store.StoreId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.Store'  is null.");
            }
            var store = await _context.Store.FindAsync(id);
            if (store != null)
            {
